...
I have provided the _nnUNet_ folder I used for experimentation, but without the data (which we cannot share). I have also uploaded the files _nii2niigz.py_ and _npy2niigz.py_ in case you require them for data conversion. Just provide proper paths to your data in the files before execution. 
