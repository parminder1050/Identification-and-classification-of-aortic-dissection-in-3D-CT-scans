...
#SBATCH --job-name=pk
#SBATCH -o predict_e100_3dfullres_fall.out
#SBATCH -t 72:00:00
...
#/home3/hghr96/miniconda3/envs/nnUnet/bin/nnUNetv2_predict -i /home3/hghr96/parm/work/AD_project/segmentation/nnUNet/testdata_instances_from_data/imagesTs -o /home3/hghr96/parm/work/AD_project/segmentation/nnUNet/testdata_instances_from_data/Dataset501_AD/3dfullres/imagesTs_prediction_fold1 -d 501 -c 3d_fullres -f 1 -chk checkpoint_best.pth --save_probabilities -device 'cuda' --disable_progress_bar -npp 1 -nps 1


#/home3/hghr96/miniconda3/envs/nnUnet/bin/nnUNetv2_plan_and_preprocess -d 502 --verify_dataset_integrity -npfp 2 -np 2

#/home3/hghr96/miniconda3/envs/nnUnet/bin/nnUNetv2_train 501 3d_fullres 'all' --npz

#/home3/hghr96/miniconda3/envs/nnUnet/bin/nnUNetv2_predict -i /home3/hghr96/parm/work/AD_project/segmentation/nnUNet/testdata_instances_from_data/imagesTs -o /home3/hghr96/parm/work/AD_project/segmentation/nnUNet/testdata_instances_from_data/Dataset501_AD/3dlowres/imagesTs_prediction_fold0 -d 501 -c 3d_lowres -f 0 -chk checkpoint_best.pth --save_probabilities -device 'cuda' --disable_progress_bar -npp 1 -nps 1


/home3/hghr96/miniconda3/envs/nnUnet/bin/nnUNetv2_predict -i /home3/hghr96/parm/work/AD_project/segmentation/nnUNet/testdata_instances_from_data/imagesTs -o /home3/hghr96/parm/work/AD_project/segmentation/nnUNet/testdata_instances_from_data/Dataset501_AD/3dfullres/imagesTs_prediction_foldall -d 501 -c 3d_fullres -f 'all' -chk checkpoint_best.pth --save_probabilities -device 'cuda' --disable_progress_bar -npp 1 -nps 1
